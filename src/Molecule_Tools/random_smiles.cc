                       ...
                       char flag)
{
  ...
  data_source_and_type<Molecule_and_Atom_Type> input(SMI, fname);
...
static int
make_random_smiles(const char * fname, int input_type, std::ostream & output)
{
...
#ifdef SEED_SETTING_TEMPORARILY_TURNED_OFF
