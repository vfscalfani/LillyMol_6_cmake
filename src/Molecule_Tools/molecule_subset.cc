                         ...
                         Molecule_Output_Object & output)
{
  ...
  int * include_bond = new_int (m.nedges(), 0); iw_auto_array<int> free_include_bond (include_bond);
                 ...
                 Molecule_Output_Object & output)
{
  ...
  int * remove_atom = new int[matoms]; iw_auto_array<int> free_remove_atom (remove_atom);
...
static int
display_standard_dash_M_options (ostream & os)
{
