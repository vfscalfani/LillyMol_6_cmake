...
void
add_aromatic(aromaticity_type_t & arom) {
  arom |= _AROM_BIT;
}

void
add_aliphatic(aromaticity_type_t & arom) {
  arom |= _ALIPH_BIT;
}

bool
is_aromatic_atom(aromaticity_type_t arom) {
  return (_AROM_BIT & arom) != 0;
}

bool
is_aliphatic_atom(aromaticity_type_t arom) {
