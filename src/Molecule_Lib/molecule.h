...
//  template <typename T> int write_molecule_mdl     (const char *, const char *) const;
    ...
    template <typename T> int write_molecule_mdl     (T &, const IWString &);
    template <typename T> int write_molecule_mdl_v30 (T &, const IWString &, int);
    ...
    template <typename T> int write_connection_table_mdl (T &);
