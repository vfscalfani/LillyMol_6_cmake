                                      ...
                                      const IWString & v)
{
  ...
  {
    cerr << "CmdLine_Option_and_Value::set_value: unrecognised type " << valid_as << '\n';
    return 0;
  }
...
{
//cerr << "CmdLine_Option_and_Value:converting '" << _value << "' to type " << sizeof(T) << '\n';
...
Command_Line_v2::_load_rest_into_array (int argc,
                                ...
                                int istart)
{
//cerr << "Loading from " << istart << " to " << argc << '\n';
